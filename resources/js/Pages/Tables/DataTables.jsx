            ...
            <div className="container-fluid">
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <table id="datatable-buttons" className="table table-striped dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">State Saving</h4>
                                <p className="card-subtitle mb-4">
                                ...
                                <table id="state-saving-datatable" className="table activate-select dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
                    ...
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                ...
                                <table id="selection-datatable" className="table dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Key Data Table</h4>
                                <p className="card-subtitle mb-4">
                                ...
                                <table id="key-datatable" className="table dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Complex headers with column visibility</h4>
                                <p className="card-subtitle mb-4">
